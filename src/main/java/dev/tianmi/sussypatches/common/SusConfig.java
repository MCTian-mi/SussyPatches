...
public class SusConfig {
    ...
    public static final class Feature {
        ...
        @Name("Add retain exact mode to covers")
        @RequiresMcRestart
        ...
        @Name("Dynamic fluid cell texture")
        @RequiresMcRestart
    ...
    public static final class Compat {
        ...
        @Name("Check OptiFine Shader at real time")
        @RequiresMcRestart
    ...
    public static final class Tweaks {
        ...
        @Name("Allow mob spawning on GT stones")
        @RequiresMcRestart
        ...
        @Name("Improve Multiblock auto-building")
        @RequiresMcRestart
