...
import dev.tianmi.sussypatches.common.stoichiometry.apachemath.util.CombinatoricsUtils;
...
public class DSCompiler {
    ...
    private DSCompiler(final int parameters, final int order,
        ...
        this.derivativesIndirection = compileDerivativesIndirection(parameters, order,
