 ...
 */
package dev.tianmi.sussypatches.common.stoichiometry.apachemath.optim.linear;

import java.util.ArrayList;
import java.util.List;

import dev.tianmi.sussypatches.common.stoichiometry.apachemath.exception.TooManyIterationsException;
import dev.tianmi.sussypatches.common.stoichiometry.apachemath.optim.MaxIter;
...
import dev.tianmi.sussypatches.common.stoichiometry.apachemath.util.Precision;
...
public class SimplexSolver extends LinearOptimizer {
    ...
    public PointValuePair doOptimize()
        ...
        final SimplexTableau tableau = new SimplexTableau(getFunction(),
                getConstraints(),
                getGoalType(),
